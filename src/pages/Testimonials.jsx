          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                className={`px-8 py-3 rounded-lg font-semibold transition-all duration-200 ${activeTab === 'written'
              ...
              <button
                ...
                className={`px-8 py-3 rounded-lg font-semibold transition-all duration-200 flex items-center gap-2 ${activeTab === 'video'
                    ? 'bg-primary-500 text-white shadow-lg'
                    : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                  }`}
              >
